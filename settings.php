 ...
 *
 */
$drupal_hash_salt = file_get_contents('/private/salt.txt');
...
$conf['file_public_path'] = '/sb4dev/files';
$conf['file_private_path'] = '/sb4dev/private';
$conf['encrypt_secure_key_path'] = '/sb4dev/keys';
